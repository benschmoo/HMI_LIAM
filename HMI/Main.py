...
IndLeftOrig = PhotoImage(file=r"/home/pi/repos/HMI_LIAM/HMI/venv/Pictures/IndLeft.png")
IndLeftResize = IndLeftOrig.resize((60,40), Image.ANTIALIAS)
IndLeft = ImageTk.PhotoImage(IndLeftResize)
IndRightOrig = PhotoImage(file="/home/pi/repos/HMI_LIAM/HMI/venv/Pictures/IndRight.png")
IndRightResize = IndRightOrig.resize((60,40), Image.ANTIALIAS)
IndRight = ImageTk.PhotoImage(IndRightResize)
WarnLightOrig = PhotoImage(file="/home/pi/repos/HMI_LIAM/HMI/venv/Pictures/Warnblinker.png")
WarnLightResize = WarnLightOrig.resize((60,60), Image.ANTIALIAS)
WarnLight = ImageTk.PhotoImage(WarnLightResize)
HornOrig = Image.open("/home/pi/repos/HMI_LIAM/HMI/venv/Pictures/Horn.png")
HornResize = HornOrig.resize((50,30), Image.ANTIALIAS)
